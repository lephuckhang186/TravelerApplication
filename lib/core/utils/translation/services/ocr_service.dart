...
class OCRService {
  ...
  Future<String?> extractTextFromCamera() async {
    if (kIsWeb) {
      throw Exception('Camera không khả dụng trên web. Vui lòng sử dụng "Chọn từ thư viện" để upload ảnh từ máy tính.');
    }
    
    throw Exception('Tính năng chụp ảnh chỉ khả dụng trên thiết bị di động (Android/iOS)');
  }
