...
class _TranslationScreenState extends State<TranslationScreen>
  ...
  Widget _buildLanguageSelector() {
    return Container(
      ...
      child: Row(
        children: [
          Expanded(
            child: _buildLanguageButton(_sourceLanguage, true),
          ),
          ...
          const SizedBox(width: 16),
          Expanded(
            child: _buildLanguageButton(_targetLanguage, false),
          ),
        ],
      ),
    );
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          _buildActionButton(
                            icon: Icons.content_copy,
                            onTap: () => _copyToClipboard(_targetController.text),
                          ),
                          const SizedBox(width: 8),
                          _buildActionButton(
  ...
  void _startListening() {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(content: Text('Tính năng nhận diện giọng nói sẽ được thêm')),
    );
  }
}