  ...
  void _initializeForm() {
    if (widget.activity != null) {
      ...
      if (activity.budget != null) {
        _estimatedCostController.text = activity.budget!.estimatedCost
            .toString();
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Category: ${widget.activity!.expenseInfo.expenseCategory}',
                  ),
                  Text(
                    'Auto-synced: ${widget.activity!.expenseInfo.autoSynced ? "Yes" : "No"}',
                  ),
                ],
              ),
            ),
  ...
  void _saveActivity() {
    ...
    if (_estimatedCostController.text.isNotEmpty) {
      budget = BudgetModel(
        ...
        category: ExpenseIntegration.mapActivityTypeToExpenseCategory(
          _selectedType,
        ),
      );
    }
    ...
    if (_contactNameController.text.isNotEmpty ||
      ...
      contact = ContactModel(
        name: _contactNameController.text.isNotEmpty
