      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildInfoItem('Mã hóa dữ liệu', 'Tất cả dữ liệu được mã hóa SSL/TLS'),
            _buildInfoItem('Quyền riêng tư', 'Chúng tôi không chia sẻ thông tin cá nhân'),
            _buildInfoItem('Lưu trữ', 'Dữ liệu được lưu trữ an toàn trên cloud'),
            const SizedBox(height: 12),
            Row(
              children: [
                Expanded(
