              ...
              children: [
                ...
                if (widget.isSignUp) ...[
                  ...
                  _buildTextField(
                    ...
                    validator: (value) {
                      final validation = _validationService.validateFullName(
                        value ?? '',
                      );
                ...
                _buildTextField(
                  ...
                  suffixIcon: _isCheckingEmail
                      ...
                      : null,
                  validator: (value) {
                    final validation = _validationService.validateEmail(
                      value ?? '',
                    );
                    return validation.isValid ? null : validation.message;
                  },
                ...
                _buildTextField(
                  ...
                  validator: (value) {
                    if (widget.isSignUp) {
                      final validation = _validationService.validatePassword(
                        value ?? '',
                      );
                      return validation.isValid ? null : validation.message;
                    } else {
