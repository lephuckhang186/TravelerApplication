  ...
  Future<void> _sendMessage() async {
    ...
    try {
      ...
      if (mounted) {
        setState(() {
          _messages.add({
            'content': 'Xin lỗi, tôi không thể kết nối đến server AI ngay lúc này. Vui lòng thử lại sau. \n\nLỗi: $e',
            'role': 'assistant',
          });
          _isLoading = false;
        });
  ...
  Future<String> _callTravelAgentAPI(String userInput) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        return responseData['summary'] ?? 'Xin lỗi, tôi không thể tạo phản hồi.';
      } else {
              ...
              Expanded(
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    final firstMessage = chatHistory.isNotEmpty ? chatHistory[0]['content'] ?? '' : '';
