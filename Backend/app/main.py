...
try:
    from .api.endpoints import expenses, auth, planners, collaborators, activities, firestore_statistics, weather, shared_planners, edit_requests, activity_edit_requests
...
app.include_router(activity_edit_requests.router, prefix=settings.API_V1_STR)
if travel_agent:
